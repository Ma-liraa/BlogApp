...
export default function Search() {
  ...
  return (
    <form
      className="mb-4 break-inside-avoid w-full rounded-3xl bg-[#3B66FF]/10 p-2 shadow-[0_0_20px_rgba(59,102,255,0.5)] md:mb-0"
      onSubmit={formSubmit}
    >
      <div
        className={`flex w-full items-center gap-x-2 rounded-2xl bg-[#C3CDFF]`}
      >
        <button
          type="submit"
